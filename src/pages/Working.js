    ...
    />
      {isLoadingLanguages && <div>Loading Languages...</div>}   
                        ...
                        <div className='mt-16   flex gap-4 items-center'>
                            <button style={{ background: "#fe7544" }} onClick={handleNotesClick} className='p-2 px-1 text-center text-white w-44  rounded-lg '>Get Topic-wise Notes</button>
                        ...
                        <div className='mt-16   flex gap-4 items-center'>
                            <button style={{ background: "#fe7544" }} onClick={handleQuestionClick} className='p-2 px-1 text-center text-white w-44  rounded-lg '>Ask any Question</button>
