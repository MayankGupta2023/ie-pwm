...
const AuthPage = () => {
  ...
  return (
    <div className='overflow-hidden h-screen'>
      ...
      <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 pb-12 ">
        <motion.div
        ...
        >
          <motion.div className="flex mb-6">
            <motion.div
              ...
              whileTap={{ scale: 0.9 }}
              className={`cursor-pointer text-2xl mx-2 ${isLogin ? 'text-blue-600 font-semibold' : 'text-gray-600'
                }`}
