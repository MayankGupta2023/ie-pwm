...
const DropdownButton = ({ selectedItem, secondDropdownItems, onSelect, onToggle, hint }) => {
    ...
    return (
        <div className="relative font-inter font-medium inline-block text-left">
            <button
            ...
            {isOpen && (
                <div className="z-10 origin-top-right absolute font-medium left-0 w-44  mt-2 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
